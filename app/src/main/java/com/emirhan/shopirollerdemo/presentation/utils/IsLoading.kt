...
object IsLoading {
    fun withCategories(state: CategoriesDto): Boolean = state.isLoading && state.data == null

    fun withProduct(state: ProductDto): Boolean = state.isLoading && state.data == null

    fun withProducts(state: ProductsDto): Boolean = state.isLoading && state.data == null
